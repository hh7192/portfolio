...
})({"jw504":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f6155354088d9622";
...
},{}],"f0Ghg":[function(require,module,exports) {
...
class UI {
    ...
    totalExpense() {
        let total1 = 0;
        if (this.itemList.length > 0) total1 = this.itemList.reduce(function(total, curr) {
            total += curr.amount;
...
function eventListeners() {
    ...
    expenseList.addEventListener('click', function(event) {
        if (event.target.parentElement.classList.contains('edit-icon')) ui.editExpense(event.target.parentElement);
        else if (event.target.parentElement.classList.contains('delete-icon')) ui.deleteExpense(event.target.parentElement);
    });
}
// Step5: calling function when DOM loads.
...
},{}]},["jw504","f0Ghg"], "f0Ghg", "parcelRequiree843")

//# sourceMappingURL=budgetapp.088d9622.js.map
